...
import {
  ...
  OWNER,
  VETERINARIAN,
} from "../../../assets/resources/UserType";
    ...
    return (
      <Fragment>
        <VetProfileComponent
          ...
          address={props.veterinarian.vetAddress}
        />
    ...
    return (
      <Fragment>
        <UserProfileComponent
          data={props.owner}
          address={props.owner.ownerAddress}
        />
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-12 justify-content-center text-center">
            ...
            <Button
              className="btn-third"
              label="Transfer Puppy Ownership"
  ...
  const getPuppyProfile = () => {
    return (
      <AnimalProfileComponent
        data={props.puppy}
        address={props.puppy.puppyAddress}
      />
    );
  };
          ...
          <div className="col-lg-10 col-md-12 justify-content-center text-center">
            <div className="card p-5">
              ...
              <div className="row justify-content-center">
                ...
                <div className="col-lg-4 col-sm-12 mb-3">
                  <Button onClick={getVeterinarianData}>
