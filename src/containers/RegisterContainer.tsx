...
const RegisterContainer = (props: any) => {
  ...
  return (
    <RegisterComponent
      ...
      PuppyJSON={PuppyJSON}
      onSubmitVeterinarian={() =>
        props.registerVeterinarian(
          config,
      ...
      onSubmitPuppy={(puppyType: number, puppySex: number) =>
        props.registerPuppy(
          config,
          puppyType,
          puppySex,
      ...
      onSubmitOwner={(ownerType: number) =>
        props.registerOwner(
          config,
          ownerType,
          _.mapValues(formData, (o) => {
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  registerVeterinarian: (config: any, data: string) =>
    dispatch(registerVeterinarian(config, data)),
  registerPuppy: (
    config: any,
    puppyType: number,
    puppySex: number,
    data: string
  ) => dispatch(registerPuppy(config, puppyType, puppySex, data)),
  registerOwner: (config: any, ownerType: number, data: string) =>
    dispatch(registerOwner(config, ownerType, data)),
});
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(injectIntl(RegisterContainer))
);
